...
if cmp -s out.txt func_tests/neg_01_out.txt
then echo OK
fi

echo NEG_02
./app.exe func_tests/neg_02_in.txt year > out.txt
if cmp -s out.txt func_tests/neg_02_out.txt
then echo OK
fi

echo NEG_03
./app.exe func_tests/neg_03_in.txt year > out.txt
if cmp -s out.txt func_tests/neg_03_out.txt
then echo OK
fi

echo NEG_04
./app.exe func_tests/neg_04_in.txt year > out.txt
if cmp -s out.txt func_tests/neg_04_out.txt
then echo OK
fi

echo NEG_05
./app.exe func_tests/neg_05_in.txt year > out.txt
if cmp -s out.txt func_tests/neg_05_out.txt
then echo OK
fi

echo NEG_07
./app.exe func_tests/neg_07_in.txt year > out.txt
if cmp -s out.txt func_tests/neg_07_out.txt
then echo OK
fi

echo NEG_08
./app.exe func_tests/neg_08_in.txt year > out.txt
if cmp -s out.txt func_tests/neg_08_out.txt
then echo OK
fi

echo NEG_09
./app.exe func_tests/neg_09_in.txt year 0> out.txt
if cmp -s out.txt func_tests/neg_09_out.txt
then echo OK
fi

echo NEG_10
./app.exe func_tests/neg_10_in.txt year ee> out.txt
if cmp -s out.txt func_tests/neg_10_out.txt
then echo OK
fi

echo NEG_11
./app.exe func_tests/neg_11_in.txt year -4> out.txt
if cmp -s out.txt func_tests/neg_11_out.txt
then echo OK
fi

echo NEG_12
./app.exe func_tests/neg_12_in.txt year asd ASD qww> out.txt
if cmp -s out.txt func_tests/neg_12_out.txt
then echo OK
fi

echo NEG_13
./app.exe > out.txt
if cmp -s out.txt func_tests/neg_13_out.txt 
then echo OK
fi

echo NEG_14
./app.exe func_tests/neg_14_in.txt years > out.txt
if cmp -s out.txt func_tests/neg_14_out.txt
then echo OK
fi
exit 0
